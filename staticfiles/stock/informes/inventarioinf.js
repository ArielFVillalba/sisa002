...
if ($.fn.DataTable.isDataTable('#movdeplst')) {
    $('#inventariolst').DataTable().destroy();
}
...
var deposito = document.getElementById('id_depostio').value;
...
pag="";
if (tipolist=="general"){
if (web=="web"){ pag="/inv_inf_gral_listar/";  }
if (web=="pdf"){ pag="";  }
};
valida=true;
...
if (tipolist=="detallado"){
    if (nrotoma >= 1) {
    if (web=="web"){ pag="/inv_inf_det_listar/";  }
    } else {  alert("INGRESAR NRO DE TOMA"); valida=false; }

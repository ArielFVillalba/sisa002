...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstdet" onClick="editarcompradet('+ compradet.orden +')" >  EDITAR </button> ';
      html += '<button  class="btnlstdet" onClick="compradet_eliminar(\''+compradet.pkfd+'\')" >ELIMINAR </button> </div>';
      html += '</div> ';
      html += '</div> ';

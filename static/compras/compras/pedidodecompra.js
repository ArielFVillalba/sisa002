...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstm" onClick="editarpedidocompdet('+ pedidocompdet.orden +')" >  EDITAR </button> ';
      html += '<button  class="btnlste" onClick="pedidocompdet_eliminar(\''+pedidocompdet.pkpcd+'\' )" >ELIMINAR </button> </div>';
      html += '</div> ';
      html += '</div> ';

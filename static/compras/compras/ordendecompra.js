...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstm" onClick="editarordencompadet('+ ordencompdet.orden +')" >  EDITAR </button> ';
      html += '<button  class="btnlste" onClick="ordencompradet_eliminar(\''+ordencompdet.pkfd+'\' )" >ELIMINAR </button> </div>';
      html += '</div> ';
      html += '</div> ';

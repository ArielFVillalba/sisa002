...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstm" onClick="editarnotacreditoventadet('+ notacreditoventadet.orden +')" >  EDITAR </button> ';
      html += '<button  class="btnlste" onClick="notacreditoventadet_eliminar(\''+notacreditoventadet.pkncd +'\' )" >ELIMINAR </button> </div>';
      html += '</div> ';
      html += '</div> ';

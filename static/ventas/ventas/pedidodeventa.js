...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstm" onClick="editarpedidoventadet('+ pedidoventadet.orden +')" >  EDITAR </button> ';
      html += '<button  class="btnlste" onClick="pedidoventadet_eliminar(\''+pedidoventadet.pkpvd +'\' )" >ELIMINAR </button> </div>';
      html += '</div> ';
      html += '</div> ';

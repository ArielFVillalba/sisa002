...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstm" onClick="editarpresupuestoventadet('+ presupuestoventadet.orden +')" >  EDITAR </button> ';
      html += '<button  class="btnlste" onClick="presupuestoventadet_eliminar(\''+presupuestoventadet.pkpvd +'\' )" >ELIMINAR </button> </div>';
      html += '</div> ';
      html += '</div> ';

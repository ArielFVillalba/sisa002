...
if ($.fn.DataTable.isDataTable('#notadecreditodeventalst')) {
    $('#notadecreditodeventalst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
function lstnotacredventaexp(web){
...
if (tipolist=="general"){
if (web=="pdf"){ pag="/notacreditodeventacabinfpdf/"; }
if (web=="excel"){ pag="/notacreditodeventacabinfexcel/"; }
if (web=="csv"){ pag="/notacreditodeventacabinfcsv/"; }
if (web=="imp"){ pag="/notacreditodeventacabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/notacreditodeventadetinfpdf/"; }
if (web=="excel"){ pag="/notacreditodeventadetinfexcel/"; }
if (web=="csv"){ pag="/notacreditodeventadetinfcsv/"; }
if (web=="imp"){ pag="/notacreditodeventacabinfimp/"; }
};
valida=true;
if (valida==true){
...
function listnotacreditoventa(web){
if (web=="web"){
...
if (web=="web" && tipolist=="general"){ pag="/notacreditodeventacabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/notacreditodeventadetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarnotacreditodeventa(list);   }
     if (web=="web" && tipolist=="detallado") { listarnotacreditodeventadet(list);}

}});
}
}

function listarnotacreditodeventa(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#notadecreditodeventalst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro nota</th> <th>cliente</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
html+=" <th>"+ venta.fecha  +"</th> <th>"+ venta.nronota +"</th>";
...
$('#notadecreditodeventalst').html(html);
$('#notadecreditodeventalst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarnotacreditodeventadet(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#notacreditodeventalst')) {
        $('#notacreditodeventalst').DataTable().destroy();
    }

var html = '';

html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro nota</th> <th>cliente</th> <th>orden</th> <th>codigo </th> ';
...
$('#notacreditodeventalst th').css({'font-size':'12px'});
$('#notacreditodeventalst thead th').css({'font-size':'12'});

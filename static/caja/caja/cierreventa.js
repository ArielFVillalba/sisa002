...
function printTicket() {
    ...
    printWindow.document.write('<link rel="stylesheet" href="style.css" type="text/css" />'); // Incluye el CSS si es necesario
    printWindow.document.write('</head><body>');
    printWindow.document.write(ticketContent);
    printWindow.document.write('</body></html>');

    // Cerrar el documento para iniciar el proceso de impresión
    ...
    printWindow.onload = function() {
        ...
        // Cerrar la ventana de impresión después de que se haya completado
        printWindow.close();
    };
}
